...
public record GetEmploymentTypeMastersAsDropdownQuery
    (DropdownQueryParams queryParams, CancellationToken cancellationToken = default) : IQuery<ApiResponse>;

public class GetEmploymentTypeMastersAsDropdownQueryHandler(IEmploymentTypeMasterRepository _repository) : IQueryHandler<GetEmploymentTypeMastersAsDropdownQuery, ApiResponse>
{
    public async Task<ApiResponse> Handle(GetEmploymentTypeMastersAsDropdownQuery request, CancellationToken cancellationToken)
    {
