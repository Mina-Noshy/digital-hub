...
public record DeleteEmploymentTypeMasterCommand
    (long id, CancellationToken cancellationToken = default) : ICommand<ApiResponse>;


public class DeleteEmploymentTypeMasterCommandHandler(IEmploymentTypeMasterRepository _repository) : ICommandHandler<DeleteEmploymentTypeMasterCommand, ApiResponse>
{

    public async Task<ApiResponse> Handle(DeleteEmploymentTypeMasterCommand request, CancellationToken cancellationToken)
    {
