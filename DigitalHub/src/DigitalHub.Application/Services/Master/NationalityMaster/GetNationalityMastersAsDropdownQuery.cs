...
public record GetNationalityMastersAsDropdownQuery
    (DropdownQueryParams queryParams, CancellationToken cancellationToken = default) : IQuery<ApiResponse>;

public class GetNationalityMastersAsDropdownQueryHandler(INationalityMasterRepository _repository) : IQueryHandler<GetNationalityMastersAsDropdownQuery, ApiResponse>
{
    public async Task<ApiResponse> Handle(GetNationalityMastersAsDropdownQuery request, CancellationToken cancellationToken)
    {
