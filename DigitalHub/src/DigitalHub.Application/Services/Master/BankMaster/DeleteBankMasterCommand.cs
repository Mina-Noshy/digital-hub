...
public record DeleteBankMasterCommand
    (long id, CancellationToken cancellationToken = default) : ICommand<ApiResponse>;


public class DeleteBankMasterCommandHandler(IBankMasterRepository _repository) : ICommandHandler<DeleteBankMasterCommand, ApiResponse>
{
