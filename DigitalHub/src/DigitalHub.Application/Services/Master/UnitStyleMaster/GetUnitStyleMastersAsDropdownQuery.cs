...
public record GetUnitStyleMastersAsDropdownQuery
    (DropdownQueryParams queryParams, CancellationToken cancellationToken = default) : IQuery<ApiResponse>;

public class GetUnitStyleMastersAsDropdownQueryHandler(IUnitStyleMasterRepository _repository) : IQueryHandler<GetUnitStyleMastersAsDropdownQuery, ApiResponse>
{
    public async Task<ApiResponse> Handle(GetUnitStyleMastersAsDropdownQuery request, CancellationToken cancellationToken)
    {
