...
public record DeleteUnitCategoryMasterCommand
    (long id, CancellationToken cancellationToken = default) : ICommand<ApiResponse>;


public class DeleteUnitCategoryMasterCommandHandler(IUnitCategoryMasterRepository _repository) : ICommandHandler<DeleteUnitCategoryMasterCommand, ApiResponse>
{

    public async Task<ApiResponse> Handle(DeleteUnitCategoryMasterCommand request, CancellationToken cancellationToken)
    {
