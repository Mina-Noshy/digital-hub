...
public record GetUnitCategoryMastersAsDropdownQuery
    (DropdownQueryParams queryParams, CancellationToken cancellationToken = default) : IQuery<ApiResponse>;

public class GetUnitCategoryMastersAsDropdownQueryHandler(IUnitCategoryMasterRepository _repository) : IQueryHandler<GetUnitCategoryMastersAsDropdownQuery, ApiResponse>
{
    public async Task<ApiResponse> Handle(GetUnitCategoryMastersAsDropdownQuery request, CancellationToken cancellationToken)
    {
