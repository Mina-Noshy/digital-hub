...
public record GetCountryMastersAsDropdownQuery
    (DropdownQueryParams queryParams, CancellationToken cancellationToken = default) : IQuery<ApiResponse>;

public class GetCountryMastersAsDropdownQueryHandler(ICountryMasterRepository _repository) : IQueryHandler<GetCountryMastersAsDropdownQuery, ApiResponse>
{
    public async Task<ApiResponse> Handle(GetCountryMastersAsDropdownQuery request, CancellationToken cancellationToken)
    {
