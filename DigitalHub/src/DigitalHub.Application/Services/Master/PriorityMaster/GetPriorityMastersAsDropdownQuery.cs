...
public record GetPriorityMastersAsDropdownQuery
    (DropdownQueryParams queryParams, CancellationToken cancellationToken = default) : IQuery<ApiResponse>;

public class GetPriorityMastersAsDropdownQueryHandler(IPriorityMasterRepository _repository) : IQueryHandler<GetPriorityMastersAsDropdownQuery, ApiResponse>
{
    public async Task<ApiResponse> Handle(GetPriorityMastersAsDropdownQuery request, CancellationToken cancellationToken)
    {
