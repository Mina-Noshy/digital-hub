...
public record DeletePriorityMasterCommand
    (long id, CancellationToken cancellationToken = default) : ICommand<ApiResponse>;


public class DeletePriorityMasterCommandHandler(IPriorityMasterRepository _repository) : ICommandHandler<DeletePriorityMasterCommand, ApiResponse>
{

    public async Task<ApiResponse> Handle(DeletePriorityMasterCommand request, CancellationToken cancellationToken)
    {
