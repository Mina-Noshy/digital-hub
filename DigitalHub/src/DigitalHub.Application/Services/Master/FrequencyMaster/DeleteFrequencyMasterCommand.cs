...
public record DeleteFrequencyMasterCommand
    (long id, CancellationToken cancellationToken = default) : ICommand<ApiResponse>;


public class DeleteFrequencyMasterCommandHandler(IFrequencyMasterRepository _repository) : ICommandHandler<DeleteFrequencyMasterCommand, ApiResponse>
{

    public async Task<ApiResponse> Handle(DeleteFrequencyMasterCommand request, CancellationToken cancellationToken)
    {
