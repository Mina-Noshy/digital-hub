...
public record GetFrequencyMastersAsDropdownQuery
    (DropdownQueryParams queryParams, CancellationToken cancellationToken = default) : IQuery<ApiResponse>;

public class GetFrequencyMastersAsDropdownQueryHandler(IFrequencyMasterRepository _repository) : IQueryHandler<GetFrequencyMastersAsDropdownQuery, ApiResponse>
{
    public async Task<ApiResponse> Handle(GetFrequencyMastersAsDropdownQuery request, CancellationToken cancellationToken)
    {
